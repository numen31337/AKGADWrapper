Pod::Spec.new do |s|
  ...
  s.author         = { "Oleksandr Kirichenko" => "akgadwrapper@ab.oleksandrkirichenko.com" }
  ...
  # According to https://github.com/CocoaPods/CocoaPods/issues/10065#issuecomment-694266259
  s.pod_target_xcconfig = {
